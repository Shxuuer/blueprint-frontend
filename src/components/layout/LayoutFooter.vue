...
<template>
  <div class="main">
    <div class="info">
      <div class="links">
        <span style="font-size: 1.5em;color: #e3e3e3">快捷入口</span>
        <div class="links-link">
          <a href="https://www.bupt.edu.cn/" target="_blank">北京邮电大学</a>
          <a href="https://scs.bupt.edu.cn/" target="_blank">北京邮电大学计算机学院（国家示范性软件学院）</a>
